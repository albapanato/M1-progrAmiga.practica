...
## Unidad 1: Arquitectura cliente-seridor
...
TCP/IP es un protocolo convinado que consiste en un enlace de datos que se usa en Internet para que los ordenadores y otros dispositivos envien y reciban datos.<br>
    ...
    Brevemente se podría explicar A (envia datos a B, pero A no sabe si se han llegado correctamente).
    TCP hace que al mandar datos , manda confirmación a A de que esos datos se han enviado, y confirmacíon de la confirmación a B de que A ha recibido la confirmación que B ha recibido los datos.

#### <u>Hay 4 capas:</u>

![img](fotos-markdown-cliente-servidor/Modelo-TCP-IP.jpg)
...
![img](<fotos-markdown-cliente-servidor/TCP vs UDP.png>)
<br>

TCP da confirmación Y UDP que no da confirmación
...
![img](<fotos-markdown-cliente-servidor/Conjunto-protocolos TCIP-IP.png>)
...
![img](fotos-markdown-cliente-servidor/como-funcionan-dominios.png)
<br>
...
![img](fotos-markdown-cliente-servidor/cliente-servidor.png)
...
![alt text](fotos-markdown-cliente-servidor/partes-de-una-url.jpg)
...
![alt text](fotos-markdown-cliente-servidor/Dferente-tipos-de-protocolos.png)
...
![alt text](fotos-markdown-cliente-servidor/Protocolo-FTP.png) <br><br>
...
![alt text](<fotos-markdown-cliente-servidor/Esquema hosting.png>)
...
![img](<fotos-markdown-cliente-servidor/Proceso de consulta de una web.png>)
